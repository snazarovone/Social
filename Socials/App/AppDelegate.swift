...
//  Eschty
//
//  Created by Aisana on 22.05.2020.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var providerGoogleServerAPI = MoyaProvider<GoogleServerAPI>(session: DefaultAlamofireManager.sharedManager, plugins: [
        NetworkLoggerPlugin(configuration: NetworkLoggerPlugin.Configuration(logOptions: [.verbose, .formatRequestAscURL]))])
    
    var providerResultsServerAPI = MoyaProvider<ResultsUsersServerAPI>(session: DefaultAlamofireManager.sharedManager, plugins: [
        NetworkLoggerPlugin(configuration: NetworkLoggerPlugin.Configuration(logOptions: [.verbose, .formatRequestAscURL]))])
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Eschty")
